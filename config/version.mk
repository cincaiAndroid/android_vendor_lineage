...
CINCAI_VERSION := cincaiAndroid-$(CINCAI_BUILD)-v$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)@ANDROID-$(PLATFORM)-$(CINCAI_BUILD_DATE)
...
CINCAI_DISPLAY_VERSION := $(CINCAI_BUILD)-v$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(CINCAI_BUILD_DATE)
